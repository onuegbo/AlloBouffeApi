"""
Django settings for Alloapi project.
...
SECRET_KEY = '^2_&_#vd&xzdxut(j5wbge2to4kfg#fu%_5b7w!ers9*+esk5_'
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'allobouffe.apps.AllobouffeConfig',
...
WSGI_APPLICATION = 'Alloapi.wsgi.application'
